...
.welcome-banner {
    background: #5c0632;          /* Warna ungu/maroon pekat sepadan dengan Admin */
...
.search-filter-box, .map-box, .inner-card-section {
    background-color: #ffffff;
    padding: 30px;
    border-radius: 16px;
...
.btn-primary:hover { background-color: #520235;
}
...
.btn-close-purple:hover { background-color: #520235; }
