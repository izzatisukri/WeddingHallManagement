            ...
            <table id="table-users">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Owner</td>
                        <td>
                            <select class="status-select status-active" onchange="updateStatusStyle(this)">
                                <option value="Active" style="color: #2f855a;" selected>Active</option>
                                <option value="Suspended" style="color: #dd6b20;">Suspended</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
