...
if (!$conn) {
    die("<span style='color:red; font-weight:bold;'>Failed to connect to the database! Make sure MySQL in XAMPP is STARTED. Error: " . mysqli_connect_error() . "</span>");
}
...
<body>
    ...
    <div class="container">
        ...
        <div class="bookings-section">
            ...
            <div class="toast-notification" id="successToast">Booking Deleted Successfully!</div>
        </div>
